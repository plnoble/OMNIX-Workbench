...
export const APP_ENTRIES: AppEntry[] = [
  ...
  },
  {
    ...
    label: "写作",
    title: "写作工作台",
    description: "独立的 Markdown 写作空间：文件树、分屏预览、导出 HTML、选中文本 AI 助手。",
    group: "resource",
    placement: "launcher",
  },
  {
  ...
  },
  {
    ...
    label: "演示",
    title: "演示 · PPT",
    description: "AI 生成结构化幻灯，随时手动编辑、AI 精准微调，导出 PDF / HTML——每页都是可改的字段，不是图片。",
    group: "resource",
    placement: "launcher",
  },
  {
  ...
  },
  {
    ...
    label: "用量",
    title: "用量成本看板",
    description: "网关健康、token 与成本活动、按平台开销与最近请求，全部基于已采集的 request_logs。",
    group: "resource",
    placement: "launcher",
  },
  {
  ...
  },
  {
    ...
    label: "本地选型",
    title: "本地模型选型",
    description: "按本机 CPU/内存/显存推荐能跑的开源大模型与量化档（whichllm 式）。",
    group: "resource",
    placement: "launcher",
  },
  {
    ...
    label: "代码地图",
    title: "代码地图",
    description: "把项目分析成文件依赖图，d3 力导图交互探索（Understand-Anything 轻量层）。",
    group: "resource",
    placement: "launcher",
  },
  {
