...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::export_write_docx,
            commands::import_docx_markdown,
            commands::office_merge_batch,
            commands::write_outline_ai,
            commands::write_expand_ai,
            commands::office_preview_html,
            commands::excel_new,
            commands::excel_ai_edit,
            commands::excel_import_csv,
